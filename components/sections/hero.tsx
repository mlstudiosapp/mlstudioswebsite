  ...
  return (
    <section className="mx-auto w-full max-w-5xl px-6 pt-24 pb-20 sm:pt-32 sm:pb-28">
      <div className="max-w-2xl">
        <p className="label fade-up text-text-tertiary">Product &amp; Software Studio</p>

        <h1 className="fade-up mt-5 text-[clamp(2.25rem,6vw,3.5rem)] font-semibold leading-[1.08]">
          <span className="sr-only">ML Studios — </span>
          We build things that actually work.
        </h1>

        <p className="fade-up mt-6 text-lg leading-relaxed text-text-secondary">
